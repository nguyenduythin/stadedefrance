                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    <div class="text-center mb-2">
                                        <h1 class="mb-1">Thêm mới Sự kiện</h1>
                                        <p>Thêm mới Sự kiện vào danh sách của bạn!</p>
                                    </div>
                                    <form id="addForm" action="{{ route('event.add.api') }}" method="POST"
                                        ...
                                        <div class="col-12 col-md-6">
                                            <label class="form-label" for="modalEditUserFirstName">Ngày bắt đầu </label>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <form id="detailUserForm" action="{{ route('event.add.api') }}" method="POST"
                    class="row gy-1 pt-75 add-new-user" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="id" hidden>
...
<div class="modal fade show" id="editFormModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Sửa mới sự kiện</h1>
                    <p>Sửa mới sự kiện của bạn !</p>
                </div>
...
<script>
        ...
        var table = e.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    orderable: !1,
                    render: function(e, t, a, s) {
                        var url = '{{ route("admin.gallery.event.list", [":id" ]) }}';
    ...
    table.on( 'order.dt search.dt', function () {
        ...
        $('body').on('click', '#detailUser', function() {
            ...
            $.get('<?= route("event.list.api") ?>' + "/show/" + user_id, function(data) {
        ...
        $('body').on('click', '#editFormBtn', async function() {
            $('#editForm')[0].reset();
            var id = $(this).data("id");
            $.get('<?= route("event.list.api") ?>' + "/show/" + id, function(data) {
