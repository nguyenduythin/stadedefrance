        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Thư viện ảnh - {{ $event_id->title }} </h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.event.list') }}">Quay lại</a>
                                </li>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <form id="addForm" action="{{ route('gallery.event.add.api') }}" method="POST"
                    class="row gy-1 pt-75 add-new-user" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="id" hidden>
                    <div class="col-12 col-md-12">
                        <label class="form-label" for="modalEditUserFirstName">Thêm ảnh mới</label>
                        <input type="file" id="modalEditUserFirstName full_name" name="url" class="form-control"
                            accept="image/*" />
                    </div>
                        <input type="text"  hidden name="event_id" id="" value="{{ $event_id->id }}"/>
...
$('body').on('click', '#delete', function() {
            var id = $(this).data("id");
            var url = '{{ route("gallery.event.delete.api", [":id" ]) }}';
