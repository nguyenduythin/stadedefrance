                            ...
                            <div class="card-body">
                                ...
                                <div class="avatar-group">
                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        ...
                                        <img src="{{ asset('admin/images/portrait/small/avatar-s-9.jpg') }}"
                                            alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="bottom" title="Amy Carson" class="avatar pull-up">
                                        <img src="{{ asset('admin/images/portrait/small/avatar-s-6.jpg') }}"
                                            alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="bottom" title="Brandon Miles" class="avatar pull-up">
                                        <img src="{{ asset('admin/images/portrait/small/avatar-s-8.jpg') }}"
                                            alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="bottom" title="Daisy Weber" class="avatar pull-up">
                                        <img src="{{ asset('admin/images/portrait/small/avatar-s-20.jpg') }}"
                                            alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom"
                        ...
                        <div class="card card-browser-states">
                            ...
                            <div class="card-body">
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img src="{{ asset('admin/images/icons/google-chrome.png') }}"
                                ...
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img src="{{ asset('admin/images/icons/mozila-firefox.png') }}"
                                ...
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img src="{{ asset('admin/images/icons/apple-safari.png') }}"
                                ...
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img src="{{ asset('admin/images/icons/internet-explorer.png') }}"
                                ...
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img src="{{ asset('admin/images/icons/opera.png') }}" class="rounded me-1"
