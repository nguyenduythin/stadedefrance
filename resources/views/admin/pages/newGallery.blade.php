        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Thư viện ảnh Tin tức - {{ $new_id->title }} </h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.new.list') }}">Quay lại</a>
                                </li>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <form id="addForm" action="{{ route('gallery.new.add.api') }}" method="POST"
                    ...
                    <div class="col-12 col-md-12">
                        ...
                        <input type="text"  hidden name="new_id" id="" value="{{ $new_id->id }}"/>
...
$('body').on('click', '#delete', function() {
            var id = $(this).data("id");
            var url = '{{ route("gallery.new.delete.api", [":id" ]) }}';
