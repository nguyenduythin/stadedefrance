...
<div class="navbar-container d-flex content">
    <div class="bookmark-wrapper d-flex align-items-center">
          <li class="nav navbar-nav dropdown dropdown-language"><a class="nav-link dropdown-toggle" id="dropdown-flag"
                href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                    class="flag-icon flag-icon-vn"></i><span class="selected-language">Việt nam</span></a>
        </li>
...
{{--     
            ...
            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                ...
                <li class="scrollable-container media-list"><a class="d-flex" href="#">
                        <div class="list-item d-flex align-items-start">
                            <div class="me-1">
                                <div class="avatar"><img
                                        src="{{ asset('admin/images/portrait/small/avatar-s-15.jpg') }}"
                        ...
                        <div class="list-item d-flex align-items-start">
                            <div class="me-1">
                                <div class="avatar"><img
                                        src="{{ asset('admin/images/portrait/small/avatar-s-3.jpg') }}"
                                        alt="avatar" width="32" height="32"></div>
                            </div>
                            <div class="list-item-body flex-grow-1">
        ...
        <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                ...
                aria-expanded="false">
                <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">Admin</span>
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                ...
                <div class="dropdown-divider"></div><a class="dropdown-item"
                    ...
                    <a
                    class="dropdown-item" href="auth-login-cover.html" id="logout-admin"><i class="me-50"
