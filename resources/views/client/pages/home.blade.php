...
<!-- Mirrored from restabook.kwst.net/dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Oct 2021 10:32:09 GMT -->
<head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
        ...
        <link type="text/css" rel="stylesheet" href="{{ asset('client/css/dark-style.css') }}">
        ...
        <div id="main">
            ...
            <div id="wrapper">
                ...
                <div class="hero-wrap fl-wrap full-height" data-scrollax-parent="true">
                    <div class="bg par-elem "  data-bg=" {{ asset('client/images/bg/2.jpg') }}" data-scrollax="properties: { translateY: '30%' }"></div>
                ...
                <div class="content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="image-collge-wrap fl-wrap">
                                        ...
                                        <div class="images-collage-item" style="width:65%" data-position-left="68" data-position-top="-15" data-zindex="2" data-opacity="1.0"><img src=" {{ asset('client/images/all/8.jpg') }} " alt=""></div>
                                        <div class="images-collage-item col_par" style="width:120px" data-position-left="-23" data-position-top="-17" data-zindex="9" data-scrollax="properties: { translateY: '150px' }"><img src=" {{ asset('client/images/cube.png') }}" alt=""></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section data-scrollax-parent="true">
                        <div class="container">
                            ...
                            <div class="images-collage-item col_par" style="width:120px" data-position-left="83" data-position-top="87" data-zindex="1" data-scrollax="properties: { translateY: '150px' }"><img src=" {{ asset('client/images/cube.png') }}" alt=""></div>
                        </div>
                    ...
                    <section class="parallax-section dark-bg hidden-section" data-scrollax-parent="true">
                        ...
                        <div class="brush-dec"></div>
                        <div class="bg par-elem bg_tabs"  data-bg=" {{ asset('client/images/bg/4.jpg') }}" data-scrollax="properties: { translateY: '30%' }"></div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="hero-menu_header fl-wrap">
                                            <ul class="tabs-menu     no-list-style change_bg">
                                                <li class="current"><a href="#tab-1" data-bgtab="{{ asset('client/images/bg/4.jpg') }}"><span>01.</span>Main dishes</a></li>
                                                <li><a href="#tab-2" data-bgtab="{{ asset('client/images/bg/6.jpg') }}"><span>02.</span>Starter</a></li>
                                                <li><a href="#tab-3" data-bgtab="{{ asset('client/images/bg/7.jpg') }}"><span>03.</span>Desserts</a></li>
                                                <li><a href="#tab-4" data-bgtab="{{ asset('client/images/bg/5.jpg') }}"><span>04.</span>Sea Food</a></li>
                                                <li><a href="#tab-5" data-bgtab="{{ asset('client/images/bg/9.jpg') }}"><span>05.</span>Drinks</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!--  hero-menu_header  end-->
